...
public: // Type information
    ...
    union { // Gentype specific properties
        UNIONIZE(PlanetProperties planetProperties);
        UNIONIZE(StarProperties starProperties);
        UNIONIZE(GasGiantProperties gasGiantProperties);
    };

public: // Orbit Properties
    ...
    Array<const char*> comps; //< Barycenter binary components
    nString ref = ""; ///< Orbital period reference body

public: // Orientation Properties
